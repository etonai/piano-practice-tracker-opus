...
import com.pseddev.practicetracker.databinding.ActivityMainBinding
import com.pseddev.practicetracker.ui.sync.SyncDialogFragment
...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkAndShowSyncDialog() {
        val app = application as PianoTrackerApplication
