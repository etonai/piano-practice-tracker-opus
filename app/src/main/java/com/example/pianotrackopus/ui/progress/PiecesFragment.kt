...
import com.example.pianotrackopus.R
import com.example.pianotrackopus.databinding.FragmentPiecesBinding
...
class PiecesFragment : Fragment() {
    ...
    private fun showPieceDetails(details: PieceDetails) {
        ...
        val practiceCount = details.activities.count { it.activityType == com.example.pianotrackopus.data.entities.ActivityType.PRACTICE }
        val performanceCount = details.activities.count { it.activityType == com.example.pianotrackopus.data.entities.ActivityType.PERFORMANCE }
