...
- Calendar fragment and associated layouts
- Date selection styling and theming
- Activity data integration with calendar display
- Dark mode theme configurations

**Acceptance Criteria:**
- [ ] Investigate calendar date selection implementation
- [ ] Identify dark mode detection method in app
- [ ] Locate styling code for selected calendar dates
- [ ] Implement medium gray circle background for selected dates with no activities in dark mode
