...
- [ ] Test deduplication works correctly for all authorized milestone levels (3, 5, 8, 14)
...
**Acceptance Criteria:**
- [ ] Identify all locations where milestone list `listOf(3, 5, 8, 14, 21, 30, 50, 100)` is used
- [ ] Remove unauthorized milestones (21, 30, 50, 100) from tracking lists
- [ ] Update milestone list to `listOf(3, 5, 8, 14)` in all relevant files
- [ ] Verify no `streak_achieved` events are sent for milestones above 14 days
- [ ] Test that authorized milestones (3, 5, 8, 14) still work correctly
- [ ] Update any comments or documentation referencing unauthorized milestones
- [ ] Verify emoji level mapping remains correct for authorized milestones only
...
- Phase 5 removes unauthorized streak milestones above 14 days (21, 30, 50, 100)
