...
**Acceptance Criteria:**
- [ ] Modify piece detail popup to show all new statistics fields
- [ ] Display practice and performance counts with clear labels
- [ ] Show last practice/performance dates in user-friendly format
- [ ] Display second and third last activity dates for pattern visibility
- [ ] Show last satisfactory practice/performance dates
- [ ] Include piece creation date and last updated timestamp
- [ ] Add clear visual separation between different types of statistics
- [ ] Ensure popup resizes appropriately for additional information
- [ ] Implement proper handling for null/empty statistics values
- [ ] Add loading states while statistics are being calculated
...
**Acceptance Criteria:**
- [ ] Implement JSON export functionality that includes both pieces and activities
- [ ] Create JSON import functionality to restore combined data
- [ ] Maintain existing CSV export functionality unchanged
- [ ] Design comprehensive JSON schema with proper versioning
- [ ] Include piece statistics and activity relationships in JSON format
- [ ] Add user interface for choosing between CSV and JSON export formats
- [ ] Implement data validation for JSON import with error handling
- [ ] Provide import progress feedback and conflict resolution
...
- [ ] All new statistics fields display correctly in piece detail popup
- [ ] Statistics update in real-time when activities are added/edited/deleted
- [ ] Null values are handled gracefully with appropriate default text
- [ ] Date formatting is consistent and user-friendly throughout the interface
- [ ] Popup interface accommodates all information without usability issues
- [ ] Loading states provide appropriate feedback during statistics calculation
