...
- [ ] Implement favorites storage using isFavorite field in Piece entity
...
### Phase 2: JSON Export/Import for Combined Data
**Status:** 🎫 **OPEN**  
**Date Added:** 2025-07-26  
**Priority:** High  
...
- `app/src/main/java/com/pseddev/playstreak/ui/configuration/ConfigurationFragment.kt` (new)
- `app/src/main/java/com/pseddev/playstreak/ui/configuration/ConfigurationViewModel.kt` (new)
- `app/src/main/res/layout/fragment_configuration.xml` (new)
